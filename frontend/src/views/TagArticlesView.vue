<template>
  <div class="tag-articles-page">
    <h2 class="page-title">{{ tag.name }} 标签下的文章</h2>
      ...
      <el-card shadow="hover">
        <div class="tag-info-content">
          <div class="tag-info-left">
            ...
            <p class="tag-article-count">共 {{ tag.articleCount }} 篇文章</p>
          </div>
          <div class="tag-info-right">
            <el-button type="primary" size="medium">
              <router-link to="/tags" class="btn-link">
                返回标签列表
              </router-link>
            </el-button>
          </div>
